<div align="center">
  <img src="header.svg" alt="Kajetan Kisielewski" width="100%" />
</div>

<div align="center">
  <h3>Full-Stack Developer | AI Specialist | Academic Lecturer</h3>
  <p>
    I build modern web products, AI-powered workflows, and systems that solve real business problems.
    <br/>
    I also teach practical software engineering at <b>Uniwersytet VIZJA w Warszawie</b>.
  </p>
</div>
...
<table>
  <tr>
    <td width="33%" align="center">
      <h3>AI Features</h3>
      RAG systems, AI agents, prompt workflows, and production integrations with OpenAI, Anthropic, and Gemini.
    </td>
    <td width="33%" align="center">
      <h3>Full-Stack Platforms</h3>
      React/Angular frontends, Node.js backends, microservices architecture, and API-first development.
    </td>
    <td width="33%" align="center">
      <h3>Product Delivery</h3>
      From idea to deployment: architecture, implementation, testing, CI/CD, and iterative improvement.
    </td>
  </tr>
</table>
...
![WebRTC](https://img.shields.io/badge/WebRTC-111827?style=flat-square&logo=webrtc&logoColor=333333)
...
- Building AI-native features directly into web products
- Scaling full-stack apps with clean architecture and robust APIs
- Teaching practical, production-first engineering
